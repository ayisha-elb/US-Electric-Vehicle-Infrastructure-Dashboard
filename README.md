...
ev-infrastructure-analytics:  README.md,  requirements.txt,  .gitignore,  example.env,  notebooks: ev_infrastructure_analysis.ipynb,  sql: ev_project.sql,  mages showing Tableau dashboard,  .csv backup files
<br>
